...
const RECORD_GENERATE_CODE_URL = "https://chrome.google.com/webstore/detail/katalon-recorder-selenium/ljdobmomdgdljniojadhoplhkpialdid";
const KATA_SERVER_STANALONE_JAR_URL = "https://github.com/katalon-studio/katalium-server/releases/download/v1.1.0/kata-server.jar";
const PORT = 4444;
const SERVER_JAR_FILE_NAME = "katalium-server-v1.1.0.jar";

export {
  SAMPLE_PROJECT_URL,
  REPO_URL,
  KATA_SERVER_STANALONE_JAR_URL as KATA_SERVER_STANDALONE_JAR_URL,
